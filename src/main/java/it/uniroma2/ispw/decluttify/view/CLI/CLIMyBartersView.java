...
public class CLIMyBartersView extends CLIView {

    private List<BarterBean> ongoingBarters;
    private boolean onSelection;
    private BarterBean selectedBarter;

    public CLIMyBartersView(SessionManager sessionManager) {
    ...
    private void showSelection() {
        ...
        if(selectedBarter.isYouConfirmed() || selectedBarter.getStatus().equalsIgnoreCase("COMPLETED")){
            System.out.println("\n[0] Write Review   |   [1] CLIView details\n\n");
        }
        else {
            System.out.println("\n[0] Confirm barter   |   [1] CLIView details   |   [2] Open dispute\n\n");
        }
    }
