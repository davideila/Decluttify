module it.uniroma2.ispw.decluttify {
    ...
    exports it.uniroma2.ispw.decluttify.view.controller.jfx to javafx.fxml, javafx.graphics;
    opens it.uniroma2.ispw.decluttify.view.controller.jfx to javafx.fxml, javafx.graphics;
    ...
    exports it.uniroma2.ispw.decluttify.view.controller.jfx.customtiles.itemtile to javafx.fxml, javafx.graphics;
    opens it.uniroma2.ispw.decluttify.view.controller.jfx.customtiles.itemtile to javafx.fxml, javafx.graphics;
